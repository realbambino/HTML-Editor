...
Public Function RandomEx(Upperbound As Long, Lowerbound As Long) As Integer
    Randomize
    RandomEx = Int((Upperbound - Lowerbound) * Rnd + Lowerbound)
End Function

Public Function CreateHashEx(NumOfBits As Integer)
Dim rndNum As String

    For x = 0 To 50
        rndNum = rndNum & Hex(RandomEx(9999, 1))
        DoEvents
    Next x
    
    CreateHashEx = Right$(LCase$(rndNum), NumOfBits)
End Function
